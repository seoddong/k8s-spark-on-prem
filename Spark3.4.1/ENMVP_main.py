...
from ENMVP_setting import setup_logging, get_aws_credentials, create_spark_session, mariadb_url, db_properties
...
def process_batch(last_batch_time, initial_run=False):
    global spark, df_product, df_employees, df_code, df_iso
    ...
    if df_product is None or df_employees is None or df_code is None or df_iso is None:
